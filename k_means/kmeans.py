...
# Using K-Means Unsupervised Learning
# ============================================================
...
CLUSTER_INFO = {
    0: {
        ...
        "description": "Young customers with high income and high spending score",
        "color": "#FF6B6B",
        "characteristics": [
            "Age: 25–40",
            "Income: High",
    ...
    2: {
        ...
        "description": "Customers with average income and spending behavior",
        "color": "#45B7D1",
        "characteristics": [
            "Income: Average",
            "Spending: Average"
    ...
    3: {
        ...
        "description": "Older customers with consistent purchasing behavior",
        "color": "#FFA07A",
        "characteristics": [
            "Age: 40+",
            "Spending: Consistent"
...
if model is not None and df is not None:
    ...
    with col1:
        ...
        c3.metric("Spending", f"{spending}/100")
    ...
    if st.button("🚀 Predict Cluster", use_container_width=True):
        ...
        cluster_details = CLUSTER_INFO.get(
            cluster,
            {"name": "Unknown", "description": "N/A", "characteristics": []}
        )
        ...
        recommendations = {
            ...
            1: "Target with promotions and loyalty programs",
            2: "Offer discounts to increase engagement",
    ...
    st.error("Model or dataset missing. Please check file paths.")
